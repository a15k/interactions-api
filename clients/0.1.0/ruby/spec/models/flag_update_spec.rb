...
# Unit tests for A15kInteractions::FlagUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlagUpdate' do
  before do
    # run before each test
    @instance = A15kInteractions::FlagUpdate.new
  end
  ...
  describe 'test an instance of FlagUpdate' do
    it 'should create an instance of FlagUpdate' do
      expect(@instance).to be_instance_of(A15kInteractions::FlagUpdate)
    end
  end
