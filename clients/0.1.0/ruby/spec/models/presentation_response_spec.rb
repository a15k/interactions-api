...
# Unit tests for A15kInteractions::PresentationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PresentationResponse' do
  before do
    # run before each test
    @instance = A15kInteractions::PresentationResponse.new
  end
  ...
  describe 'test an instance of PresentationResponse' do
    it 'should create an instance of PresentationResponse' do
      expect(@instance).to be_instance_of(A15kInteractions::PresentationResponse)
    end
  end
