...
# Unit tests for A15k::Interactions::AppUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppUpdate' do
  before do
    # run before each test
    @instance = A15k::Interactions::AppUpdate.new
  end
  ...
  describe 'test an instance of AppUpdate' do
    it 'should create an instance of AppUpdate' do
      expect(@instance).to be_instance_of(A15k::Interactions::AppUpdate)
    end
  end
