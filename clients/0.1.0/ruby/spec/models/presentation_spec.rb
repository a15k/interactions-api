...
# Unit tests for A15kInteractions::Presentation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Presentation' do
  before do
    # run before each test
    @instance = A15kInteractions::Presentation.new
  end
  ...
  describe 'test an instance of Presentation' do
    it 'should create an instance of Presentation' do
      expect(@instance).to be_instance_of(A15kInteractions::Presentation)
    end
  end
  ...
  describe 'test attribute "presented_at"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
