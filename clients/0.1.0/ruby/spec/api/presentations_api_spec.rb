...
# Unit tests for A15kInteractions::PresentationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PresentationsApi' do
  before do
    # run before each test
    @instance = A15kInteractions::PresentationsApi.new
  end
  ...
  describe 'test an instance of PresentationsApi' do
    it 'should create an instance of PresentationsApi' do
      expect(@instance).to be_instance_of(A15kInteractions::PresentationsApi)
    end
  end
