...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new A15kInteractions.PresentationsApi();
  });
  ...
  describe('PresentationsApi', function() {
    describe('createPresentation', function() {
      it('should call createPresentation successfully', function(done) {
        //uncomment below and update the code to test createPresentation
        //instance.createPresentation(function(error) {
