...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new A15kInteractions.Presentation();
  });
  ...
  describe('Presentation', function() {
    it('should create an instance of Presentation', function() {
      ...
      //var instane = new A15kInteractions.Presentation();
      //expect(instance).to.be.a(A15kInteractions.Presentation);
    });
    ...
    it('should have the property presentedAt (base name: "presented_at")', function() {
      // uncomment below and update the code to test the property presentedAt
      //var instane = new A15kInteractions.Presentation();
      //expect(instance).to.be();
    });
