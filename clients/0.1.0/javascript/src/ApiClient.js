...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.A15kInteractions.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/api/v0
     */
    this.basePath = 'https://localhost/api/v0'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'api_id': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
