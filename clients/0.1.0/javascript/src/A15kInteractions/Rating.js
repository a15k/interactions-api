...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.A15kInteractions.Rating = factory(root.A15kInteractions.ApiClient);
  }
   ...
   * @module A15kInteractions/Rating
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>Rating</code>.
   * @alias module:A15kInteractions/Rating
   * @class
   * @param id {String} Internally-set UUID.  Used to retrieve and delete ratings, so treat it as somewhat secret.
   ...
   */
  var exports = function(id, contentUid, userUid, value) {
    var _this = this;
   ...
   * @param {module:A15kInteractions/Rating} obj Optional instance to populate.
   * @return {module:A15kInteractions/Rating} The populated <code>Rating</code> instance.
   */
  ...
  /**
   * The type of rating
   * @member {module:A15kInteractions/Rating.TypeEnum} type
   */
