...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.A15kInteractions.Flag = factory(root.A15kInteractions.ApiClient);
  }
   ...
   * @module A15kInteractions/Flag
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>Flag</code>.
   * @alias module:A15kInteractions/Flag
   * @class
   * @param id {String} Internally-set UUID.  Used to retrieve and delete flags, so treat it as somewhat secret.
   ...
   * @param type {module:A15kInteractions/Flag.TypeEnum} The type of flag
   */
  var exports = function(id, contentUid, userUid, type) {
    var _this = this;
   ...
   * @param {module:A15kInteractions/Flag} obj Optional instance to populate.
   * @return {module:A15kInteractions/Flag} The populated <code>Flag</code> instance.
   */
  ...
  /**
   * The type of flag
   * @member {module:A15kInteractions/Flag.TypeEnum} type
   */
